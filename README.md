...
<!-- TODO: replace CCBR/CCBR_SnakemakeTemplate in these badge links with your OWNER/TOOL_NAME -->

[![build](https://github.com/CCBR/CCBR_SnakemakeTemplate/actions/workflows/build-nextflow.yml/badge.svg)](https://github.com/CCBR/CCBR_SnakemakeTemplate/actions/workflows/build-nextflow.yml)
[![docs](https://github.com/CCBR/CCBR_SnakemakeTemplate/actions/workflows/docs-mkdocs.yml/badge.svg)](https://github.com/CCBR/CCBR_SnakemakeTemplate/actions/workflows/docs-mkdocs.yml)
...
The template takes inspiration from snaketool[^1].
We also have a custom template for CCBR Nextflow pipelines[^2].

[^1]: Snaketool https://github.com/beardymcjohnface/Snaketool
[^2]: Template for CCBR Nextflow pipelines: <https://github.com/CCBR/CCBR_NextflowTemplate>
